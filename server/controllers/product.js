...
export const create = async (req, res) => {
  try {
    ...
    switch (true) {
      ...
      //if we have photo than check for size in bytes
...
export const update = async (req, res) => {
  try {
    ...
    // validation - same as in create function
    switch (true) {
      case !name.trim():
    ...
    // update product fields, except files
    ...
    // update photo in case we received photo file
    if (photo) {
      product.photo.data = fs.readFileSync(photo.path);
      product.photo.contentType = photo.type;
    }
